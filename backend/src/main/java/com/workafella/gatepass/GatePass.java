...
public class GatePass {
    ...
    @Enumerated(EnumType.STRING) private GatePassStatus status = GatePassStatus.GENERATED;
    ...
    public LocalDate getVisitingDate() { return visitingDate; }
    public void setVisitingDate(LocalDate visitingDate) { this.visitingDate = visitingDate; }
